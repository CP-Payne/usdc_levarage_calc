...
def calculate_position_size():
    try:
        ...
        # New formula for position size:
        buying_power = balance * leverage  # Total trading capital with leverage
        position_size = risk_amount / abs(stop_loss_percent)  # Position size calculation

        # Ensure position size does not exceed total buying power
